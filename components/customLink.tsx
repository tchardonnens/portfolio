...
export default function CustomLink(props: any) {
  return (
    <Link href={props.link} className="inline-flex justify-center items-center p-5 text-base font-medium
     light:text-gray-900 light:bg-gray-50 rounded-lg light:hover:bg-gradient-to-r light:hover:from-indigo-500 light:hover:via-purple-500 light:hover:to-pink-500 hover:text-white
     dark:text-gray-400 dark:bg-neutral-900 dark:hover:bg-gradient-to-r dark:from-teal-500 dark:to-indigo-600 dark:hover:text-white">
